...
#orbitalParticles = [
#    #Particle([10,90], [3.0,1.3], 800000),
#    #Particle([-20,-13], [1.00,-3.7], 80000),
#    Particle([150,-50], [-0.18,-0.1], 80000),
#    #Particle([-50,-100], [-2.1,-0.5], 840000),
#    Particle([-100,-1], [-0.1,-0.1], 840000),
#    Particle([10,90], [-2.5,-0.1], 850000),
#]
#orbitalParticles = []
